      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Students:</strong> Must submit authentic credentials, certifications, and portfolio details.</li>
            <li><strong>Industries:</strong> Must post verified internship, apprenticeship, and job listings.</li>
            <li><strong>Academicians & Institutions:</strong> Must use the platform strictly for educational collaboration and progress monitoring.</li>
          </ul>
        </section>
